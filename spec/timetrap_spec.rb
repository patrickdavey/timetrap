    ...
    describe "COMMANDS" do
      ...
      describe 'edit' do
        ...
        context "with external editor" do
          ...
          it "should open an editor for editing the note", :write_stdout_stderr => true do |example|
          ...
          it "should pass existing note to editor", :write_stdout_stderr => true do |example|
            capture = nil
            Timetrap::CLI.stub(:system) do |editor_command|
              path = editor_command.match(/#{note_editor_command} (?<path>.*)/)
          ...
          context "appending" do
            it "should open an editor for editing the note with -z", :write_stdout_stderr => true do |example|
              Timetrap::CLI.stub(:system) do |editor_command|
                path = editor_command.match(/#{note_editor_command} (?<path>.*)/)
            ...
            it "should open a editor for editing the note with --append", :write_stdout_stderr => true do |example|
              Timetrap::CLI.stub(:system) do |editor_command|
                path = editor_command.match(/#{note_editor_command} (?<path>.*)/)
                File.write(path[:path], "appended in editor")
              end
